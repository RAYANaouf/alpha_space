...
@Composable
fun SoldStage(modifier: Modifier = Modifier , items : List<Int> = listOf(R.drawable.shoes , R.drawable.shoes2, R.drawable.shoes2,R.drawable.shoes , R.drawable.shoes2, R.drawable.shoes2,R.drawable.shoes , R.drawable.shoes2, R.drawable.shoes2,R.drawable.shoes , R.drawable.shoes2, R.drawable.shoes2)) {
    Column(
